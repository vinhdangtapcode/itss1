...
const translations = {
    vi: {
        ...
        analysisPlaceholder: 'Nhập phân tích (không bắt buộc)...',
    ...
    ja: {
        ...
        context: '文脈',
        analysis: '分析',
        inputPlaceholder: '翻訳したい日本語を入力...',
        contextPlaceholder: '文脈を入力（任意）...',
        outputPlaceholder: '翻訳結果がここに表示されます...',
        analysisPlaceholder: '分析を入力（任意）...',
    ...
    en: {
        ...
        analysisPlaceholder: 'Enter analysis (optional)...',
